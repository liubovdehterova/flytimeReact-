...
class BodyCreateLanding extends Component {

    render() {
        const {id, price, name, idPrice, propsOpenFormLanding, stateOpenFormLanding } = this.props;
        return(
            ...
            >
                ...
                <div className="price__inner__margin price__inner__margin-button">
                    <button className="price__inner__form"
                            onClick={ propsOpenFormLanding }
                            id={ idPrice }
                    >
                        Обсудить
                    </button>
                    {
                        stateOpenFormLanding ? <CallUsForm
                           propsOpenFormFunctionLanding={ propsOpenFormLanding }
                           stateOpenFormFunctionLanding={ stateOpenFormLanding }
                       /> : null
                    }
                </div>
...
export default BodyCreateLanding;