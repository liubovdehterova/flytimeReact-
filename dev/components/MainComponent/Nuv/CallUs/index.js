...
class CallUs extends Component {
    ...
    componentDidMount() {
        let block = document.querySelector('.ask__inner__position');
    ...
    render() {
        ...
        return (
            <>
                ...
                <div className="conteiner-item conteiner-item__position" >
                    <div className="ask" >
                        <div className="ask__inner ask__inner__position">
