...
class CallUs extends Component {
    ...
    componentDidMount() {
        let block = document.querySelector('.ask__inner__redesign-star');
    ...
    render() {
        ...
        return (
            <>
                ...
                <div className="conteiner-item conteiner-item__redesign">
                    <div className="ask">
                        <div className="ask__inner ask__inner__redesign ask__inner__redesign-star">
