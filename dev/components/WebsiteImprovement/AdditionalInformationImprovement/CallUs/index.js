...
class CallUs extends Component {
    ...
    componentDidMount() {
        let block = document.querySelector('.ask__inner__improvement-ps');
    ...
    render() {
        ...
        return (
            <>
                ...
                <div className="conteiner-item conteiner-item__improvement">
                    <div className="ask">
                        <div className="ask__inner ask__inner__improvement ask__inner__improvement-ps">
